...
public class AddressBook {
    ...
    private static void showWelcomeMessage() {
        showToUser(Array(DIVIDER, DIVIDER, VERSION, MESSAGE_WELCOME, DIVIDER));
    }

    private static void showResultToUser(String result) {
        showToUser(Array(result, DIVIDER));
    }
    ...
    private static void echoUserCommand(String userCommand) {
        showToUser(Array("[Command entered:" + userCommand + "]"));
    }
    ...
    private static void processProgramArgs(String[] args) {
        if (args.length >= 2) {
            showToUser(Array(MESSAGE_INVALID_PROGRAM_ARGS));
            exitProgram();
        }
    ...
    private static void setupGivenFileForStorage(String filePath) {
        ...
        if (!isValidFilePath(filePath)) {
            showToUser(Array(String.format(MESSAGE_INVALID_FILE, filePath)));
            exitProgram();
        }
    ...
    private static void exitProgram() {
        showToUser(Array(MESSAGE_GOODBYE, DIVIDER, DIVIDER));
        System.exit(0);
    }
    ...
    private static void setupDefaultFileForStorage() {
        showToUser(Array(MESSAGE_USING_DEFAULT_FILE));
    ...
    */
     ...
     * Uses String[] instead of String... varArgs
     */
    ...
    /**
     * Helper method for string to array of string
     * @param strings
     * @return String[]
     */
    ...
    private static void createFileIfMissing(String filePath) {
        ...
        showToUser(Array(String.format(MESSAGE_ERROR_MISSING_STORAGE_FILE, filePath)));

        try {
            storageFile.createNewFile();
            showToUser(Array(String.format(MESSAGE_STORAGE_FILE_CREATED, filePath)));
        } catch (IOException ioe) {
            showToUser(Array(String.format(MESSAGE_ERROR_CREATING_STORAGE_FILE, filePath)));
            exitProgram();
        }
    }
    ...
    private static ArrayList<HashMap<PersonProperty, String>> loadPersonsFromFile(String filePath) {
        ...
        if (!successfullyDecoded.isPresent()) {
            showToUser(Array(MESSAGE_INVALID_STORAGE_FILE_CONTENT));
            exitProgram();
        }
    ...
    private static ArrayList<String> getLinesInFile(String filePath) {
        ...
        try {
            ...
            showToUser(Array(String.format(MESSAGE_ERROR_READING_FROM_FILE, filePath)));
            exitProgram();
        }
        return lines;
    }
    ...
    private static void savePersonsToFile(ArrayList<HashMap<PersonProperty, String>> persons, String filePath) {
        ...
        try {
            ...
            showToUser(Array(String.format(MESSAGE_ERROR_WRITING_TO_FILE, filePath)));
            exitProgram();
        }
    }
